...
## SUBSCRIBE-订阅请求
在 SUBSCRIBE 包的 Fixed Header 中，有一个很重要的地方与之前的控制包以及与 v3.1.1 的包都不一样的地方。它的 Remaining Length Field 不仅仅包含了 Variable Header 的长度，它还包含 Payload 的长度。

### SUBSCRIBE Variable Head
